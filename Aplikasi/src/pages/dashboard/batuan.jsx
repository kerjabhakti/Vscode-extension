                ...
                <div className="">
                    ...
                    <CardBody>
                        <div className="grid grid-flow-row auto-rows-max gap-4 md:auto-rows-min">
                            ...
                            <Select className="shadow-lg" label="Pilih Lemari">
                                <Option value="1">01</Option>
                                <Option value="2">02</Option>
                                <Option value="3">03</Option>
                                <Option value="4">04</Option>
                            ...
                            <Input
                                className=""
                                label="Masukkan No Lajur Secara Manual 00-99"
                                type="number"
                                value={num1}
                            ...
                            <Input
                                className=""
                                label="Masukkan No Lemari Secara Manual 00-99"
                                type="number"
                                value={num2}
                            ...
                            <Input
                                className=""
                                label="Masukkan No Laci Secara Manual 00-99"
                                type="number"
                                value={num3}
                            ...
                            <Input
                                className=""
                                label="Masukkan No Slot Secara Manual"
                                type="number"
                            >
                            </Input>
                        </div>
